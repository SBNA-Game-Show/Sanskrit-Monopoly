...
function Game() {
  ...
  function handleBuyProperty() {
    ...
    if (currentPlayer.money < 100) {
      showPopup("Not Enough धनम्", "You do not have enough money to buy this property.");
      return;
    }
    ...
    showPopup("Property Bought", "You bought this cultural property for 100 धनम्.");
  }
  ...
  function handleLeaveGame() {
    showPopup("Leave Game", "Leave game clicked. Backend room logic will be connected later.");
  }
  ...
  return (
    <main className="min-h-screen w-full bg-[#161616] font-sans text-[#160f08]">
      <section className="flex min-h-screen w-full flex-col bg-[#fffaf0]">
        ...
        {/* Main Content */}
        <section className="grid flex-1 grid-cols-[290px_1fr_310px] gap-6 bg-[#fffaf0] p-6">
          {/* Players */}
      ...
      {popupTitle && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-5">
          <div className="w-full max-w-[480px] rounded-3xl border-[8px] border-[#ffa23b] bg-[#f5bd78] p-6 shadow-2xl">
            <h2 className="mb-3 text-[28px] font-bold text-[#ff514b]">{popupTitle}</h2>
